$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        //change this for your public directories files -https://github.com/juliomatcom
       var path_to_public_files = '/bundles/app/';

        if (themeName == 'classic') {
            $('#bs-css').attr('href',path_to_public_files +'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', path_to_public_files+'css/bootstrap-' + themeName + '.min.css');
        }
